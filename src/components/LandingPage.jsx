...
const LandingPage = () => {
  ...
  return (
    <div className="flex  flex-row   bg-gradient-to-tl from-primaryColor-500 via-slate-500 to-primaryColor-900  h-screen  ">
      <div className="text-primaryColor-400 h-full  flex flex-col justify-center w-full lg:w-1/2 xl:pl-20 ">
        <TypingAnimation />
      ...
      <div className="hidden   bg-transparent  md:flex items-center justify-center w-[40%] lg::w-1/2">
        <div
          ...
          className="bg-contain drop-shadow-2xl rounded-md origin-bottom  -rotate-6 scale-90  xl:scale-105 bg-no-repeat h-[400px] w-[400px]  lg:h-[500px]  lg:w-[400px] "
        >
          {" "}
        </div>
      </div>
