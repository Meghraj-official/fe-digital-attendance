      ...
      <div className="h-screen w-screen  bg-primaryColor-100  max-sm:h-screen max-sm:w-screen flex flex-row max-sm:flex-col ">
          ...
          <div className=" text-primaryColor-100   self-center">
            ...
            <div className="flex justify-center">
              <label className="font-bold font-mono text-lg text-center p-2 max-sm:text-xl ">
                Signup to welcome the future of attendance.
              </label>
            </div>
            <div className="flex justify-center mt-10 max-sm:mt-1">
              <button className=" text-primaryColor-950 h-10  max-sm:h-8 max-sm:text-sm bg-primaryColor-100 rounded-3xl  font-medium tracking-wider uppercase text-lg py-2 mx-auto md:mx-10 w-[70%] md:w-[30%]  xl:w-[30%] mt-8 lg:mt-0  xl:ml-10 ">
                <Link href="/signup">
                  <label>Sign Up</label>
                </Link>
              </button>
        ...
        <div className="w-1/2  max-sm:w-full max-sm:h-1/2 ">
          <form onSubmit={handleSubmit}>
            {/* <div className="flex justify-center  p-5 rounded-lg max-sm:w-72 max-sm:h-80 bg-red-500  "> */}
            <div className="w-full text-primaryColor-950 rounded-lg p-5 mt-32 max-sm:mt-0 max-sm:w-full max-md:h-full  ">
              ...
              <div className="flex justify-center  mt-5 max-sm:mt-1    ">
                <Button
                  className=" text-primaryColor-200 font-medium tracking-wider uppercase text-lg py-2 mx-auto max-lg:text-base md:mx-10 w-[80%] md:w-[70%]  xl:w-[50%] mt-8 lg:mt-0  xl:ml-10 "
                  buttonText="Login"
                />
              </div>
              {/* 
              <div className="flex justify-center max-sm:text-sm invisible max-sm:visible">
