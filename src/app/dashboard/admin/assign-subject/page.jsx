...
const AssignSubject = () => {
  const {
    data: verifiedTeachers,
    isLoading,
    refetch,
  } = useQuery("verified-teachers", async () => {
        ...
        <Dialog>
          ...
          <DialogContent className="bg-white ">
            <AssignSubjectModal
              ...
              assignedSubjects={rowData?.assignedSubjects}
            />
          </DialogContent>
        </Dialog>
      </div>
  ...
  return (
    <div className="px-3 ">
      <h1 className="font-medium text-start text-xl text-primaryColor-900 p-3">
        Assign Subjects
      </h1>
